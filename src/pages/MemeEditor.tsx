...
export default function MemeEditor() {
  ...
  const [gridConfig, setGridConfig] = useState<GridConfig>({ rows: 2, cols: 2, gap: 8 })
    ...
    <div className="min-h-screen bg-gradient-primary">
      ...
      <div className="pt-20 px-4">
        <div className="container mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-white mb-2">Meme Template Maker</h1>
            <p className="text-white/80">Create stunning memes with customizable grids and text styling</p>
          </div>
                  ...
                  {elements.map((element) => (
                    ...
                    >
                      <div className="text-white text-sm">
                        {element.type === 'image' ? '🖼️' : '📝'} {element.type}
                      </div>
